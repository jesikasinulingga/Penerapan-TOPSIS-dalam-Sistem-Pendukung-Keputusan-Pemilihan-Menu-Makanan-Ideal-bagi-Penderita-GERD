...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		$ada_pilihan = 1; // Secara default, semua menggunakan Pilihan Sub Kriteria
		$simpan = mysqli_query($koneksi, "INSERT INTO kriteria (id_kriteria, kode_kriteria, kriteria, type, bobot, ada_pilihan) 
			VALUES ('', '$kode_kriteria', '$nama', '$type', '$bobot', '$ada_pilihan')");
		if ($simpan) {
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input type="hidden" name="ada_pilihan" value="1">
					<input type="text" class="form-control" value="Pilihan Sub Kriteria" disabled />
				</div>
			</div>
		</div>
